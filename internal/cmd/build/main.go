...
func buildMirror(dir string) {
	cmd := exec.Command("protoc",
		...
		"--go_opt=Mmirror_consensus_service.proto=github.com/hashgraph/hedera-protobufs-go/mirror",
		"--go_opt=paths=source_relative",
		"--go-grpc_out=mirror/",
		...
		"--go-grpc_opt=Mmirror_consensus_service.proto=github.com/hashgraph/hedera-protobufs-go/mirror",
		"--go-grpc_opt=paths=source_relative",
		"-Iproto/mirror",
		"-Iproto/services",
		"proto/mirror/mirror_consensus_service.proto",
	)
